...
import com.ebay.epic.soj.flink.connector.kafka.schema.RheosKafkaRecordSerializationSchema;
...
public class FlinkKafkaProducerFactory {
  ...
  public <T> KafkaSink<T> getKafkaSink(Class<T> clazz,
                                       String rheosServiceUrls, String topic,
                                       String subject, String producerId, boolean allowDrop,
                                       String... keys) {
    RheosKafkaProducerConfig rheosKafkaConfig = new RheosKafkaProducerConfig(
    ...
    return KafkaSink.builder()
      .setKafkaProducerConfig(rheosKafkaConfig.getKafkaProps())
      .setRecordSerializer(new RheosKafkaRecordSerializationSchema(rheosKafkaConfig, clazz, keys))
