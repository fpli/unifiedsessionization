...
@Slf4j
public class RheosKafkaRecordSerializationSchema<T> implements KafkaRecordSerializationSchema<T> {
    ...
    public RheosKafkaRecordSerializationSchema(RheosKafkaProducerConfig rheosKafkaConfig, Class<T> clazz, String... keys) {
    ...
    @Override
    public ProducerRecord<byte[], byte[]> serialize(T element, KafkaSinkContext kafkaSinkContext, Long timestamp) {
