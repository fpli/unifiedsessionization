...
public class Context extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public com.ebay.epic.soj.common.model.MobileDeviceContext getDeviceInfo() {
    return deviceInfo;
  }
   ...
   * @param value the value to set.
   */
  public void setDeviceInfo(com.ebay.epic.soj.common.model.MobileDeviceContext value) {
   ...
   */
  public static com.ebay.epic.soj.common.model.Context.Builder newBuilder() {
    return new com.ebay.epic.soj.common.model.Context.Builder();
  }
   ...
   * @return A new Context RecordBuilder
   */
  public static com.ebay.epic.soj.common.model.Context.Builder newBuilder(com.ebay.epic.soj.common.model.Context.Builder other) {
    return new com.ebay.epic.soj.common.model.Context.Builder(other);
  }
   ...
   * @return A new Context RecordBuilder
   */
  public static com.ebay.epic.soj.common.model.Context.Builder newBuilder(com.ebay.epic.soj.common.model.Context other) {
    return new com.ebay.epic.soj.common.model.Context.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Context>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ebay.epic.soj.common.model.Context.Builder other) {
      super(other);
      ...
      if (other.hasDeviceInfoBuilder()) {
        this.deviceInfoBuilder = com.ebay.epic.soj.common.model.MobileDeviceContext.newBuilder(other.getDeviceInfoBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ebay.epic.soj.common.model.Context other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.appId)) {
        this.appId = data().deepCopy(fields()[0].schema(), other.appId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.Context.Builder clearAppId() {
      appId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.Context.Builder clearVersion() {
      version = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.Context.Builder clearOs() {
      os = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.Context.Builder clearUtcOffset() {
      utcOffset = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.Context.Builder clearClientIp() {
      clientIp = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.Context.Builder clearUserLang() {
      userLang = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.Context.Builder clearUserAgent() {
      userAgent = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.Context.Builder clearScreenWidth() {
      screenWidth = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.Context.Builder clearScreenHeight() {
      screenHeight = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.Context.Builder clearScreenDPI() {
      screenDPI = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.Context.Builder setDeviceInfo(com.ebay.epic.soj.common.model.MobileDeviceContext value) {
     ...
     * @return This builder.
     */
    public com.ebay.epic.soj.common.model.MobileDeviceContext.Builder getDeviceInfoBuilder() {
      if (deviceInfoBuilder == null) {
        if (hasDeviceInfo()) {
          setDeviceInfoBuilder(com.ebay.epic.soj.common.model.MobileDeviceContext.newBuilder(deviceInfo));
        } else {
          setDeviceInfoBuilder(com.ebay.epic.soj.common.model.MobileDeviceContext.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.ebay.epic.soj.common.model.Context.Builder setDeviceInfoBuilder(com.ebay.epic.soj.common.model.MobileDeviceContext.Builder value) {
      clearDeviceInfo();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.Context.Builder clearDeviceInfo() {
      deviceInfo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.Context.Builder clearOthers() {
      others = null;
