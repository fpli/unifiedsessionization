...
public class RheosHeader extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.ebay.epic.soj.common.model.RheosHeader.Builder newBuilder() {
    return new com.ebay.epic.soj.common.model.RheosHeader.Builder();
  }
   ...
   * @return A new RheosHeader RecordBuilder
   */
  public static com.ebay.epic.soj.common.model.RheosHeader.Builder newBuilder(com.ebay.epic.soj.common.model.RheosHeader.Builder other) {
    return new com.ebay.epic.soj.common.model.RheosHeader.Builder(other);
  }
   ...
   * @return A new RheosHeader RecordBuilder
   */
  public static com.ebay.epic.soj.common.model.RheosHeader.Builder newBuilder(com.ebay.epic.soj.common.model.RheosHeader other) {
    return new com.ebay.epic.soj.common.model.RheosHeader.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RheosHeader>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ebay.epic.soj.common.model.RheosHeader.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ebay.epic.soj.common.model.RheosHeader other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.eventCreateTimestamp)) {
        this.eventCreateTimestamp = data().deepCopy(fields()[0].schema(), other.eventCreateTimestamp);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.RheosHeader.Builder setEventCreateTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.RheosHeader.Builder clearEventCreateTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.RheosHeader.Builder setEventSentTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.RheosHeader.Builder clearEventSentTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.RheosHeader.Builder setSchemaId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.RheosHeader.Builder clearSchemaId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.RheosHeader.Builder clearEventId() {
      eventId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.soj.common.model.RheosHeader.Builder clearProducerId() {
      producerId = null;
