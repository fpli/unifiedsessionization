...
public class RheosHeader extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -958795810801119306L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RheosHeader\",\"namespace\":\"org.ebayanalytics.globalevent\",\"fields\":[{\"name\":\"eventCreateTimestamp\",\"type\":\"long\"},{\"name\":\"eventSentTimestamp\",\"type\":\"long\"},{\"name\":\"schemaId\",\"type\":\"int\"},{\"name\":\"eventId\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"producerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static org.ebayanalytics.globalevent.RheosHeader.Builder newBuilder() {
    return new org.ebayanalytics.globalevent.RheosHeader.Builder();
  }
   ...
   * @return A new RheosHeader RecordBuilder
   */
  public static org.ebayanalytics.globalevent.RheosHeader.Builder newBuilder(org.ebayanalytics.globalevent.RheosHeader.Builder other) {
    return new org.ebayanalytics.globalevent.RheosHeader.Builder(other);
  }
   ...
   * @return A new RheosHeader RecordBuilder
   */
  public static org.ebayanalytics.globalevent.RheosHeader.Builder newBuilder(org.ebayanalytics.globalevent.RheosHeader other) {
    return new org.ebayanalytics.globalevent.RheosHeader.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RheosHeader>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.ebayanalytics.globalevent.RheosHeader.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.ebayanalytics.globalevent.RheosHeader other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.eventCreateTimestamp)) {
        this.eventCreateTimestamp = data().deepCopy(fields()[0].schema(), other.eventCreateTimestamp);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ebayanalytics.globalevent.RheosHeader.Builder setEventCreateTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ebayanalytics.globalevent.RheosHeader.Builder clearEventCreateTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ebayanalytics.globalevent.RheosHeader.Builder setEventSentTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ebayanalytics.globalevent.RheosHeader.Builder clearEventSentTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ebayanalytics.globalevent.RheosHeader.Builder setSchemaId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ebayanalytics.globalevent.RheosHeader.Builder clearSchemaId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ebayanalytics.globalevent.RheosHeader.Builder setEventId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ebayanalytics.globalevent.RheosHeader.Builder clearEventId() {
      eventId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ebayanalytics.globalevent.RheosHeader.Builder setProducerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.ebayanalytics.globalevent.RheosHeader.Builder clearProducerId() {
      producerId = null;
