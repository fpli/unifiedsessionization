...
@Slf4j
public class UniSessionAgg
        implements AggregateFunction<RawEvent, UniSessionAccumulator, UniSessionAccumulator> {
    ...
    @Override
    public UniSessionAccumulator add(RawEvent value, UniSessionAccumulator accumulator) {
        try {
