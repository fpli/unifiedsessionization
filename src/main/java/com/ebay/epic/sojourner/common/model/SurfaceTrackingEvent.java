...
public class SurfaceTrackingEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.ebay.epic.sojourner.common.model.AutoTrackEvent autoTrackEvent;
   ...
   */
  public SurfaceTrackingEvent(com.ebay.epic.sojourner.common.model.RheosHeader rheosHeader, com.ebay.epic.sojourner.common.model.AutoTrackEvent autoTrackEvent) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: autoTrackEvent = (com.ebay.epic.sojourner.common.model.AutoTrackEvent)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.ebay.epic.sojourner.common.model.AutoTrackEvent getAutoTrackEvent() {
   ...
   * @param value the value to set.
   */
  public void setAutoTrackEvent(com.ebay.epic.sojourner.common.model.AutoTrackEvent value) {
   ...
   */
  public static com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent.Builder newBuilder() {
    return new com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent.Builder();
  }
   ...
   * @return A new SurfaceTrackingEvent RecordBuilder
   */
  public static com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent.Builder newBuilder(com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent.Builder other) {
    return new com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent.Builder(other);
  }
   ...
   * @return A new SurfaceTrackingEvent RecordBuilder
   */
  public static com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent.Builder newBuilder(com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent other) {
    return new com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SurfaceTrackingEvent>
    ...
    private com.ebay.epic.sojourner.common.model.AutoTrackEvent autoTrackEvent;
    private com.ebay.epic.sojourner.common.model.AutoTrackEvent.Builder autoTrackEventBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent.Builder other) {
      super(other);
      ...
      if (other.hasAutoTrackEventBuilder()) {
        this.autoTrackEventBuilder = com.ebay.epic.sojourner.common.model.AutoTrackEvent.newBuilder(other.getAutoTrackEventBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.rheosHeader)) {
        this.rheosHeader = data().deepCopy(fields()[0].schema(), other.rheosHeader);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent.Builder setRheosHeader(com.ebay.epic.sojourner.common.model.RheosHeader value) {
     ...
     * @return This builder.
     */
    public com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent.Builder setRheosHeaderBuilder(com.ebay.epic.sojourner.common.model.RheosHeader.Builder value) {
      clearRheosHeader();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent.Builder clearRheosHeader() {
      rheosHeader = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent.Builder setAutoTrackEvent(com.ebay.epic.sojourner.common.model.AutoTrackEvent value) {
     ...
     * @return This builder.
     */
    public com.ebay.epic.sojourner.common.model.AutoTrackEvent.Builder getAutoTrackEventBuilder() {
      if (autoTrackEventBuilder == null) {
        if (hasAutoTrackEvent()) {
          setAutoTrackEventBuilder(com.ebay.epic.sojourner.common.model.AutoTrackEvent.newBuilder(autoTrackEvent));
        } else {
          setAutoTrackEventBuilder(com.ebay.epic.sojourner.common.model.AutoTrackEvent.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent.Builder setAutoTrackEventBuilder(com.ebay.epic.sojourner.common.model.AutoTrackEvent.Builder value) {
      clearAutoTrackEvent();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.sojourner.common.model.SurfaceTrackingEvent.Builder clearAutoTrackEvent() {
      autoTrackEvent = null;
    ...
    public SurfaceTrackingEvent build() {
      try {
        ...
        if (autoTrackEventBuilder != null) {
          ...
          record.autoTrackEvent = fieldSetFlags()[1] ? this.autoTrackEvent : (com.ebay.epic.sojourner.common.model.AutoTrackEvent) defaultValue(fields()[1]);
        }
        return record;
